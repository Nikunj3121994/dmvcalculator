...
namespace ps.dmv.web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : ps.dmv.web.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ps.dmv.web.Models.LoginViewModel model, string returnUrl);

        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(ps.dmv.web.Models.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ps.dmv.web.Models.RegisterViewModel model);

        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Register(ps.dmv.web.Models.RegisterViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ps.dmv.web.Controllers.AccountController.ManageMessageId? message);

        public override System.Web.Mvc.ActionResult Manage(ps.dmv.web.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ps.dmv.web.Models.ManageUserViewModel model);

        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Manage(ps.dmv.web.Models.ManageUserViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ps.dmv.web.Models.ExternalLoginConfirmationViewModel model, string returnUrl);

        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ExternalLoginConfirmation(ps.dmv.web.Models.ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ExternalLoginConfirmation);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "returnUrl", returnUrl);
